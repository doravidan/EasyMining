...
def command(config, result):
    ...
    if result == "Pascalcoin":
        ...
        cmd = ['Claymore\\ethdcrminer64.exe', '-epool', 'eth-eu1.nanopool.org:9999', '-ewal', config.wallet_address_ETH, '-epsw', 'x', '-dpool', 'stratum+tcp://yiimp.ccminer.org:3252', '-dwal', config.wallet_address_Decred, '-dpsw', 'x']
    elif result == "LBRY":
